...
/**
 * 函数式编程 之 Predicate 断言 封装条件或判别式 if..else替代 1、 new EqualPredicate<类型>(值)
 * EqualPredicate.equalPredicate(值); 2、NotNullPredicate.INSTANCE
 * 3、UniquePredicate.uniquePredicate() 4、自定义 new Predicate() +evaluate
