...
/**
 * 函数式编程 Closure 闭包 封装特定的业务功能 1、Closure 2、IfClosure
 * IfClosure.ifClosure(断言,功能1,功能2) 3、WhileClosure
 * WhileClosure.whileClosure(断言,功能,标识) 4、ChainedClosure.chainedClosure(功能列表);
