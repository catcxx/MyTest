...
/**
 * 迭代器的扩展 1、MapIterator 以后不再使用map.keySet.iterator访问 IterableMap HashedMap
 * 2、UniqueFilterIterator 去重迭代器 3、FilterIterator 自定义过滤 +Predicate
 * 4、LoopingIterator 循环迭代器 5、ArrayListIterator 数组迭代器
 * 
