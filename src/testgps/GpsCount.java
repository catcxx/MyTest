...
//		File f1= new File("G:\\in\\*");//20w
		File filelist = new File("F:\\sparkshare\\getstratege\\stra\\0613\\good\\step1\\AT0044.txt");
//		File f2= new File("G:\\str\\strday\\1");
		...
		BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream("F:\\sparkshare\\getstratege\\stra\\0613\\good\\step1\\"+file[i]),"UTF-8"));//构造一个BufferedReader类来读取文件
